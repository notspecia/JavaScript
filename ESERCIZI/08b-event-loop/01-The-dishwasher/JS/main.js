 ...
 */
function createDirtyStack() {
    let platesDirty = []; // stack (array), which will contain the dirty plates
...
function displayStacks(stackCleanPlates, stackDirtyPlates) {
    ...
    console.log(`STACK OF DIRTY PLATES 🍽💩:
...
function runSimulation() {
    ...
    // stack (array), containing clean dishes (initially will be empty!)
...
// variables for max and min number of plats
const min_piatti = 10;
const max_piatti = 50;
