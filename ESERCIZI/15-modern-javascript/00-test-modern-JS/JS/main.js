...
- Creare direttamente delle variabili e assegnarli i valori inseriti nel'destructing
- Puoi ignorare gli elementi che non ti servono lasciando uno spazio vuoto
- Se un valore nell'array è undefined, puoi specificare un valore predefinito nel destructuring

! 03. rest operators ...
- Usa il rest operator ... permettono di raccogliere un numero variabile di argomenti in un array. 
...
//     console.log(fifth);
//     console.log(rest);
//     console.log(`mi chiamo Gabriele e mi piacciono i seguenti sport : ${rest.join(", ")}.`);
// }
...
//     if (relase <= 2000) {
//         console.log(`u're game ${videogame}, is old (but good!)`);
//     } else {
