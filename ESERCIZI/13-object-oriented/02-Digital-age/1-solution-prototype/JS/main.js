...
// constructor function for `MusicVideo` which also extends `Video`
function MusicVideo(config) {
    Video.call(this, config);
    this.artist = config.artist || "unknown";
}

// extend the `Video` prototype in the `MusicVideo` constructor
...
// adding the .play() method to the `MusicVideo` prototype
